...
- If context is insufficient (default assumption):
    ...
    - Create NO MORE THAN 5 focused and comprehensive steps that cover the most essential aspects
...
# Output Format
Structure your response according to the Plan model
...
- Always use the language specified by the locale = en-US.