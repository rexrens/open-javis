...
class Inbox:
    ...
    # -- queues --------------------------------------------------------------
    #
    # ``next_turn``/``next_step`` expose the LIVE queues (dsh getter
    # semantics — mutation through the property is visible). Deliberate
    # divergence from the javis/harness copy that returns a defensive copy.
